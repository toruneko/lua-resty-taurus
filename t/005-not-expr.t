...
our $HttpConfig = <<'_EOC_';
    ...
    init_by_lua_block {
        ...
        local text = io.open("$TEST_NGINX_CWD/t/rule/005-not-expr.yaml"):read("*a")
...
=== TEST 1: not range rule expr match 100
...
=== TEST 2: not range rule expr match 300
--- http_config eval: $::HttpConfig
--- config
    location = /t {
        content_by_lua_block {
...
=== TEST 3: not range rule expr not match 200
--- http_config eval: $::HttpConfig
--- config
    location = /t {
        content_by_lua_block {
