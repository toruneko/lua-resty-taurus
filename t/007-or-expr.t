...
our $HttpConfig = <<'_EOC_';
    ...
    init_by_lua_block {
        ...
        local text = io.open("$TEST_NGINX_CWD/t/rule/007-or-expr.yaml"):read("*a")
...
=== TEST 3: or expr match 150 without param2
--- http_config eval: $::HttpConfig
--- config
    location = /t {
        content_by_lua_block {
...
=== TEST 4: or expr match 150 without param
--- http_config eval: $::HttpConfig
--- config
    location = /t {
        content_by_lua_block {
...
=== TEST 5: or expr not match 100 without param2
--- http_config eval: $::HttpConfig
--- config
    location = /t {
        content_by_lua_block {
