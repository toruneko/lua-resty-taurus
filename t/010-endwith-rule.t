...
our $HttpConfig = <<'_EOC_';
    ...
    init_by_lua_block {
        ...
        local text = io.open("$TEST_NGINX_CWD/t/rule/010-endwith-rule.yaml"):read("*a")
...
=== TEST 3: endwith rule not match, no parameter
--- http_config eval: $::HttpConfig
--- config
    location = /t {
        content_by_lua_block {
