...
our $HttpConfig = <<'_EOC_';
    ...
    init_by_lua_block {
        ...
        local text = io.open("$TEST_NGINX_CWD/t/rule/009-startwith-rule.yaml"):read("*a")
...
=== TEST 2: startwith rule not match
--- http_config eval: $::HttpConfig
--- config
    location = /t {
        content_by_lua_block {
...
=== TEST 3: startwith rule not match, no parameter
--- http_config eval: $::HttpConfig
--- config
    location = /t {
        content_by_lua_block {
